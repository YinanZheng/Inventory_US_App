        ...
        tabsetPanel(
          ...
          tabPanel(
            ...
            div(
              ...
              uiOutput("dynamic_download_button", style = "margin-top: 10px;")  # 动态生成按钮
            )
          ),
          
          tabPanel(
            "美国售出发货", icon = tags$img(src = '/var/www/icons/icons8-usa-48.png', height = '20px', style = 'margin-right: 5px;'),
            div(
              class = "card",
