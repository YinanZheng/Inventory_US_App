    ...
    div(
      ...
      lapply(seq_len(nrow(matching_orders)), function(i) {
        ...
        div(
          ...
          # 图片部分
          div(
            style = "text-align: center; flex: 1; max-width: 45%; padding-right: 10px;",  # 设置图片部分宽度，去掉多余间距
            img(
              src = img_path,
              height = "280px",
          ...
          # 订单信息部分
          div(
            style = "flex: 1; max-width: 55%; height: 100%; overflow-y: auto; padding-left: 10px;",  # 设置订单信息部分宽度，去掉多余间距
            tags$table(
